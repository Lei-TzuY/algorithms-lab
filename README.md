...
Phases 1–9 are sealed. Phase 10 is active: general graph matching. The first executable hypothesis is maximum-cardinality matching in arbitrary undirected graphs via Edmonds' blossom algorithm, with exhaustive small-graph verification and exact cross-checking against the sealed Hopcroft–Karp solver on bipartite instances. No weighted-blossom or unrelated matching variants are implied by this promotion.
